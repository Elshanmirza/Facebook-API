const myDiv = document.getElementById("news-container");
    ...
    <div class="news-box">
        <div class="news-head">
            <div class="profile-info">
                <img id="profile-photo" src="${jsonData[i].pimage}" alt="">

                  <div class="pimage-info">
                     <a id="profile-name" href="">${jsonData[i].pname}</a>
         ...
         <div class="news-paragraph">
              <p id="paragraph">${jsonData[i].p}</p>
        </div>

        <img id="news-image" src="${jsonData[i].image}" alt="">
